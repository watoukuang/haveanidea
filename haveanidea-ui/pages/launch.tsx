...
import {type LaunchPayload, submitIdea} from '../api/idea';
...
export default function Launch(): React.ReactElement {
    ...
    const [chain, setChain] = React.useState<'eth' | 'sol' | 'bsc' | 'polygon'>('eth');
        ...
        <Layout>
            <div className="px-4 lg:px-12 max-w-screen-2xl mx-auto py-8 md:py-12 pb-24 lg:pb-16">
                <div className="mb-8 md:mb-12 text-center">
                    <h1 className="text-3xl md:text-5xl font-extrabold tracking-tight leading-tight mb-3 bg-gradient-to-r from-blue-600 via-indigo-600 to-emerald-600 bg-clip-text text-transparent dark:from-sky-400 dark:via-indigo-400 dark:to-emerald-300">Launch
                        · Deploy Your Idea On-Chain</h1>
                    <p className="mx-auto max-w-2xl text-[13.5px] md:text-base leading-relaxed text-gray-600 dark:text-gray-300">Store
                        your idea permanently on blockchain with IPFS. Immutable, verifiable, and truly decentralized
                        ownership.</p>
                </div>

                <div className="relative max-w-2xl mx-auto">
                    <div
                        className="absolute -inset-1 rounded-2xl bg-gradient-to-r from-emerald-400/70 via-sky-500/70 to-fuchsia-600/70 blur-2xl opacity-35"></div>
                    <div
                        className="relative rounded-2xl border bg-white/90 border-gray-200 dark:bg-[#0f1115]/90 dark:border-violet-500/40 backdrop-blur px-6 md:px-7 py-7 md:py-8 shadow-sm md:shadow dark:shadow-[0_0_0_1px_rgba(67,56,202,0.5)]">
                        <form onSubmit={onSubmit} className="space-y-5 md:space-y-6">
                            {error && (
                                error === '请先连接钱包' ? (
                                    <div
                                        className="p-4 rounded-xl border border-blue-200 bg-blue-50/80 dark:border-blue-800/50 dark:bg-blue-900/20">
                                        <div className="flex items-start justify-between gap-4">
                                            <div className="flex items-start gap-3">
                                                <div className="text-xl leading-none">🦊</div>
                                                <div>
                                                    <div
                                                        className="font-medium text-blue-900 dark:text-blue-200">请先连接钱包
                                                    </div>
                                                    <div
                                                        className="text-xs text-blue-800/80 dark:text-blue-300/80 mt-0.5">提交前需连接钱包以完成签名与部署。
                                                    </div>
                                                </div>
                                            </div>
                                            <button
                            ...
                            {message && (
                                <div
                                    className="p-3 rounded-lg border border-emerald-300 bg-emerald-50/80 text-emerald-800 text-sm dark:border-emerald-700/60 dark:bg-emerald-900/20 dark:text-emerald-200">
                                    {message}
                                </div>
                            )}
                            ...
                            <div>
                                <label className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-200"><span
                                    className="text-red-500 mr-1">*</span>Idea Title</label>
                            ...
                            <div>
                                <label className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-200"><span
                                    className="text-red-500 mr-1">*</span>Idea Icon</label>
                                <div className="flex items-center gap-4">
                                    <div className="flex-shrink-0">
                                        {iconPreview ? (
                                            ...
                                            <div
                                                className="w-16 h-16 rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-600 flex items-center justify-center">
                            ...
                            <div>
                                <label className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-200"><span
                                    className="text-red-500 mr-1">*</span>Chain</label>
                                <select
                                    value={chain}
                                    onChange={(e) => setChain(e.target.value as 'eth' | 'sol' | 'bsc' | 'polygon')}
                                    className="w-full rounded-md bg-white text-gray-900 border border-gray-200 px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-indigo-400/30 focus:border-indigo-400/60 dark:bg-[#171a21] dark:text-gray-100 dark:border-transparent dark:focus:ring-2 dark:focus:ring-indigo-500/30 dark:focus:border-indigo-400/60"
                                >
                            ...
                            <div>
                                <label
                                    className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-200">Tags</label>
                                <input value={tags} onChange={(e) => setTags(e.target.value)}
                                       placeholder="e.g. DeFi, NFT, Gaming, AI (comma separated)"
                                       className="w-full rounded-md bg-white text-gray-900 placeholder-gray-400 border border-gray-200 px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-indigo-400/30 focus:border-indigo-400/60 dark:bg-[#171a21] dark:text-gray-100 dark:placeholder-gray-500 dark:border-transparent dark:focus:ring-2 dark:focus:ring-indigo-500/30 dark:focus:border-indigo-400/60"/>
                            </div>
                            ...
                            <div>
                                <div className="flex items-center justify-between">
                                    <label
                                        className="block text-sm font-medium mb-1 text-gray-700 dark:text-gray-200"><span
                                        className="text-red-500 mr-1">*</span>Your Idea & Requirements</label>
                                    <span
                                        className="text-xs text-gray-500 dark:text-gray-400">{idea.length}/{maxLen}</span>
                                </div>
                                <textarea value={idea} onChange={(e) => setIdea(e.target.value.slice(0, maxLen))}
                                          rows={6}
                                          placeholder="Briefly describe your idea, target audience, timeline, and any resources you need"
                                          className="w-full rounded-md bg-white text-gray-900 placeholder-gray-400 border border-gray-200 px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-indigo-400/30 focus:border-indigo-400/60 resize-y dark:bg-[#171a21] dark:text-gray-100 dark:placeholder-gray-500 dark:border-transparent dark:focus:ring-2 dark:focus:ring-indigo-500/30 dark:focus:border-indigo-400/60"/>
                            </div>
                            ...
                            <div className="border-t border-gray-200 dark:border-gray-700 pt-5">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    />
                                    <label htmlFor="enableCrowdfunding"
                                           className="text-sm font-medium text-gray-700 dark:text-gray-200">
                                        🚀 Enable Crowdfunding (Optional)
                                    </label>
                                </div>
                                <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">
                                    Launch a crowdfunding campaign to get support for your idea. Choose from multiple
                                    funding models.
                                </p>
                                ...
                                {enableCrowdfunding && (
                                    <div className="space-y-4 pl-7">
                                        ...
                                        <div>
                                            <label
                                                className="block text-sm font-medium mb-2 text-gray-700 dark:text-gray-200">Crowdfunding
                                                Model</label>
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                                <label
                                                    className="flex items-center p-3 border rounded-lg cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 dark:border-gray-600">
                                                    <input
                                                        type="radio"
                                                ...
                                                <label
                                                    ...
                                                    />
                                                    <div>
                                                        <div className="font-medium text-sm">🎯 Presale Crowdfunding
                                                        </div>
                                                        <div className="text-xs text-gray-500 dark:text-gray-400">
                                        ...
                                        <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                            <p className="text-sm text-blue-800 dark:text-blue-200">
                                                💡 <strong>Launch Parameters:</strong> After deployment, configure
                                                pricing, funding goals, and contact details in your idea's detail page
                                                (owner-only access).
                                            </p>
                                        </div>
                                    </div>
                            ...
                            <div className="pt-2">
                                <button type="submit" disabled={submitting}
                                        className="w-full inline-flex items-center justify-center rounded-md px-5 py-3 text-sm font-medium text-black bg-amber-400 hover:bg-amber-300 disabled:opacity-60 disabled:cursor-not-allowed shadow">
                                    {submitting ? (
                                        <>
                                            <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-black" fill="none"
                                                 viewBox="0 0 24 24">
